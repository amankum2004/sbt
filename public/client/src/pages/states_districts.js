...
// var ArunachalPradesh = ["Anjaw", "Changlang", "Dibang Valley", "East Kameng", "East Siang", "Kra Daadi", "Kurung Kumey", "Lohit", "Longding", "Lower Dibang Valley", "Lower Subansiri", "Namsai", "Papum Pare", "Siang", "Tawang", "Tirap", "Upper Siang", "Upper Subansiri", "West Kameng", "West Siang", "Itanagar"];
// // Define arrays for other states similarly
...
//     // Set the HTML content of district dropdown
//     $("#inputDistrict").html(htmlString);
// });
...
const StateInfo = {
    Delhi: {
      ...
      South: {
        "Badarpur": ["75201", "75202"],
        "Lajpat Nagar": ["73301", "73344"],
      },
      East: {
        Dallas: ["75201", "75202"],
        Austin: ["73301", "73344"],
  ...
  window.onload = function () {
    ...
    districtSelection.disabled = true; // remove all options bar first
    ...
    stateSelection.onchange = (e) => {
        ...
        // todo: Load states by looping over stateStateInfo
        for (let district in StateInfo[e.target.value]) {
    ...
    districtSelection.onchange = (e) => {
        ...
        citySelection.length = 1; // remove all options bar first
        zipSelection.length = 1; // remove all options bar first
        for (let city in StateInfo[stateSelection.value][e.target.value]) {
    ...
    citySelection.onchange = (e) => {
        ...
        zipSelection.length = 1; // remove all options bar first
        let zips = StateInfo[stateSelection.value][districtSelection.value][e.target.value];
  ...
  //     if (!stateSelection || !districtSelection || !citySelection || !zipSelection) {
  ...
  //         {
  //           name:"south delhi",
  //           cities: ["sarita vihar","badarpur","madanpur khadar"]
  //         },
  //         {
  //           name:"central delhi",
  //           cities:["new delhi","ito","secretariat"]
  //         },
  //         {
  //           name:"east delhi",
  //           cities:["botanical garden","electronic city"]
  //         },
  //       ],
  //     },
  //     {
  ...
  //             <option value={sts.name}>{sts.name}</option>
  //           ))}
  //         </select>
  //         <br/>
  //         <select className="form-control" value={district}>
