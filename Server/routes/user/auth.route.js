...
const { signupSchema, loginSchema, resetPasswordSchema } = require("../../validators/auth-validator")
...
router.route('/update').post(validate(resetPasswordSchema), authControllers.update)
