        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                ...
                className={`flex items-center justify-center space-x-2 py-3 px-6 rounded-xl font-medium transition-all duration-200 shadow-md min-w-[180px] ${
                  isCapturingLocation 
                    ...
                    : 'bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white transform hover:-translate-y-0.5'
                }`}
              >
                {isCapturingLocation ? (
                  <>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-green-100">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 gap-4">
              ...
              <button 
                ...
                className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-3 rounded-xl font-medium transition-all duration-200 transform hover:-translate-y-0.5 shadow-md flex items-center justify-center gap-2 min-w-[140px]"
              >
            ...
            <div className="space-y-4">
              {data.services.map((service, index) => (
                <div key={index} className="bg-green-50 rounded-xl p-4 border-2 border-green-200">
                  <div className="flex flex-col lg:flex-row lg:items-end gap-4">
                    <div className="flex-1 space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full h-12 border border-gray-300 rounded-lg px-4 text-base focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all bg-white" 
                      />
                    </div>
                    ...
                    <div className="lg:w-32 space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          value={service.price}
                          onChange={(e) => handleServiceChange(e, index)} 
                          className="w-full h-12 border border-gray-300 rounded-lg pl-8 pr-4 text-base focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all bg-white" 
                        />
                      </div>
                    </div>
          ...
          <div className="text-center pt-4">
            <button 
              ...
              className={`bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-bold py-4 px-12 rounded-xl text-lg transition-all duration-300 shadow-lg transform hover:-translate-y-1 active:translate-y-0 min-w-[200px] ${
...
//       <h2 className="text-3xl text-center font-bold text-purple-600 mb-8 mt-8">Update Shop Profile</h2>
