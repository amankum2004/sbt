        ...
        <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-slate-50 via-cyan-50 to-amber-50 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-10 mt-3">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-cyan-500 to-amber-400 rounded-full mb-4">
                ...
                <div className="overflow-hidden rounded-3xl border border-white/70 bg-white/90 shadow-[0_24px_70px_-20px_rgba(15,23,42,0.35)] backdrop-blur">
                    {/* Quick Navigation */}
                    <div className="bg-gradient-to-r from-cyan-50 to-amber-50 p-6 border-b border-slate-200">
                        <h2 className="text-xl font-semibold text-slate-900 mb-4 flex items-center">
                            <DocumentTextIcon className="h-5 w-5 mr-2 text-cyan-700" />
                            Quick Navigation
                        </h2>
                            ...
                            {['Introduction', 'Information We Collect', 'How We Use Data', 'Data Sharing', 
                              'Your Rights', 'Security', 'Cookies', 'Contact'].map((item, index) => (
                                <a 
                                    ...
                                    className="px-4 py-2 bg-white border border-cyan-200 text-cyan-700 rounded-full text-sm font-medium hover:bg-cyan-50 hover:border-cyan-300 transition-all duration-200"
                                >
                                    {item}
                                </a>
                            ))}
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        >
                            ...
                            <div className="mt-6 bg-gradient-to-r from-cyan-50 to-amber-50 p-5 rounded-xl">
                                <h4 className="font-semibold text-cyan-800 mb-2">Legal Basis for Processing</h4>
                        ...
                        >
                            ...
                            {/* <div className="mt-8 p-6 bg-gradient-to-r from-cyan-500 to-amber-400 rounded-xl text-white">
                        ...
                        {/* Acknowledgement */}
                        <div className="mt-12 p-8 bg-gradient-to-r from-slate-900 to-cyan-950 rounded-2xl text-white">
                ...
                <div className="mt-10 text-center">
                    <p className="text-slate-600 mb-4">You might also want to read:</p>
                    <div className="flex flex-wrap justify-center gap-4">
                        <a 
                            href="/terms-of-service" 
                            className="px-6 py-3 bg-white border border-slate-300 text-slate-700 rounded-xl hover:bg-cyan-50 hover:border-cyan-300 transition-all duration-200 font-medium shadow-sm"
                        >
                            📄 Terms of Service
                        </a>
                        <a 
...
const Section = ({ id, icon, title, children }) => (
    <div id={id} className="mb-12 scroll-mt-20">
        <div className="flex items-center mb-6">
            {icon && (
                <div className="mr-3 p-2 bg-gradient-to-r from-cyan-100 to-amber-100 rounded-lg">
...
const InfoCard = ({ title, color, items }) => {
    const colorClasses = {
        ...
        pink: 'border-amber-200 bg-amber-50',
            ...
            <ul className="space-y-2">
                {items.map((item, index) => (
                    <li key={index} className="flex items-center text-sm text-slate-700">
                        <div className={`w-1.5 h-1.5 rounded-full mr-2 ${bulletClasses[color]}`}></div>
                        {item}
                    </li>
                ))}
            </ul>
...
const UsageItem = ({ title, description }) => (
    <div className="flex items-start">
        <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-r from-cyan-500 to-amber-400 rounded-full flex items-center justify-center mr-3 mt-1">
...
const SharingCard = ({ title, items, requirement }) => (
    <div className="p-5 border border-slate-200 rounded-xl bg-white">
        ...
        <ul className="space-y-2 mb-3">
            {items.map((item, index) => (
                <li key={index} className="text-slate-700 text-sm flex items-center">
...
const RightCard = ({ title, description }) => (
    <div className="p-5 border border-slate-200 rounded-xl hover:border-cyan-300 hover:shadow-sm transition-all duration-200">
        <div className="w-10 h-10 bg-gradient-to-r from-cyan-100 to-amber-100 rounded-lg flex items-center justify-center mb-3">
            <CheckCircleIcon className="h-5 w-5 text-cyan-700" />
        </div>
...
const SecurityMeasure = ({ title, description }) => (
    <div className="flex items-center p-4 border border-slate-200 rounded-lg hover:bg-slate-50 transition">
        <LockClosedIcon className="h-5 w-5 text-slate-500 mr-3" />
        <div>
            <h4 className="font-semibold text-slate-900">{title}</h4>
            <p className="text-slate-600 text-sm mt-1">{description}</p>
        </div>
...
const ContactItem = ({ icon, type, value, link }) => (
    <div className="flex items-center">
        ...
        <span className="w-24 text-slate-600 text-sm ml-2">{type}:</span>
        {link ? (
            <a 
                href={link} 
                className="text-cyan-700 hover:text-cyan-800 font-medium hover:underline ml-2"
            >
                {value}
            </a>
        ) : (
